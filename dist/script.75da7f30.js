...
function upload(selector) {
  ...
  var upload = element('button', ['btn'], 'Load');
  ...
  var truggerInput = function truggerInput() {
    return input.click();
  };
  ...
  var removeHandler = function removeHandler(event) {
    ...
    var block = preview.querySelector("[data-name=\"".concat(name, "\"]")).closest('.preview-image'); //можно анимировать
  ...
  open.addEventListener('click', truggerInput);
